      ...
      <AnimatePresence>
        {isLoading && (
          ...
          >
            ...
            <h2 className="text-3xl font-bold text-white mb-2 text-gradient">Running POA + GA Optimization...</h2>
            <p className="text-xl text-gray-400 animate-pulse">Analyzing climate patterns...</p>
          </motion.div>
        )}
      </AnimatePresence>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                className="w-full mt-6 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold py-3.5 px-4 rounded-xl flex items-center justify-center gap-2 transition-all group shadow-lg shadow-indigo-500/20"
              >
                Run Optimization
